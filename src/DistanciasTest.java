...
public class DistanciasTest{
    ...
    public static void main(String[] args) {
        DistanciasTest distancias = new DistanciasTest();
        double d = MAX_DISTANCIA_PRUEBA;
        List<Personas>amigos=new ArrayList();
        List<Personas>otros=new ArrayList();

        amigos = distancias.generarData((int) Math.floor(Math.random()*MAX_AMIGOS_PRUEBA));
        otros = distancias.generarData((int) Math.floor(Math.random()*MAX_OTROS_PRUEBA));
    ...
    public int estimar(int m, double dt, List<Personas> amigos,int rf, DistanciasTest distancias, int n, List<Personas> otros){
        if(m > 0){
    ...
    public int estimarGrupo(DistanciasTest distancias, List<Personas> personas, double dt, int rf){
        double d = dt / 2;
    ...
    public int estimarGrupos(int n,List<Personas> otros, double dt, DistanciasTest distancias, int rf, List<Personas> amigos){
        for(int i = 0; i < n; i++){
